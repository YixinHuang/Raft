...
func (u *unstable) maybeFirstIndex() (int, bool) {
	if u.snapshot != nil {
...
func (u *unstable) maybeLastIndex() (int, bool) {
	if l := len(u.entries); l != 0 {
		return u.offset + int(l) - 1, true
	}
	if u.snapshot != nil {
...
// is any.
func (u *unstable) maybeTerm(i int) (int, bool) {
	if i < u.offset {
		if u.snapshot == nil {
			return 0, false
		}
...
func (u *unstable) stableTo(i, t int) {
	gt, ok := u.maybeTerm(i)
	if !ok {
		return
	}
...
func (u *unstable) stableSnapTo(i int) {
...
func (u *unstable) truncateAndAppend(ents []Entry) {
	...
	switch {
	case after == u.offset+int(len(u.entries))-1:
	...
	default:
		...
		u.entries = append([]Entry{}, u.slice(u.offset, after+1)...)
		u.entries = append(u.entries, ents...)
	}
}
...
func (u *unstable) mustCheckOutOfBounds(lo, hi int) {
	...
	upper := u.offset + int(len(u.entries))
